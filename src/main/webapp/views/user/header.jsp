      ...
      <div class="row">
        <div class="col-lg-9">
          <div class="header__top__left">
            <ul>
              <li><i class="fa fa-envelope"></i> GwenShop@hcmute.edu.vn</li>
              <li>Miễn phí ship cho đơn từ 500k</li>
              <li><i class="fa fa-phone"></i> 0328614013</li>
            </ul>
          </div>
        </div>
        <div class="col-lg-3">
          <div class="header__top__right">
            <div class="header__top__right__social">
              <a href="cart"><i class="fa fa-bag-shopping"></i> Giỏ hàng </a>
            </div>
  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-12" style="display: flex">
        <div class="header__logo" style="margin: auto;">
          <a href="home">
            <img style="height: 100px; width: auto" src="/views/public/images/gwen_logo.png">
          </a>
        </div>
      </div>
    </div>
